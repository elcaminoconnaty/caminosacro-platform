// Pantalla de aviso de la página pública de documentación (enlace inválido o anulado).
// Copia deliberada de la de /contrato/[token]: son dos páginas públicas distintas y
// acoplarlas por un componente compartido haría que tocar una cambiara la otra.
